...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Game.is_done'
        db.add_column('ms_game', 'is_done', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Game.is_done'
        db.delete_column('ms_game', 'is_done')
